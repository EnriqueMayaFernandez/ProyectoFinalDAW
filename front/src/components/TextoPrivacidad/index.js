...
export default function Explicacion() {
  return (
    <div className="w-3/4 min-h-screen space-y-5 bg-white border border-black rounded-md p-2 shadow-2xl pl-6 pr-6">
      <p>
        TermoApp te informa sobre su Política de Privacidad respecto del
        ...
        contratación de servicios a través del sitio Web www.termoapp.es.
      </p>
      <p>
      ...
      <h2 className="text-lg font-bold">Identidad del responsable</h2>

      <li>Titular: TermoApp</li>
      <li>NIF/CIF: 123456789A</li>
      <li>Domicilio: Calle Madrid 102, Getafe</li>
      <li>Correo electrónico: info@termoapp.es</li>
      <li>Sitio Web: www.termoapp.es</li>
      ...
      <li>
        ...
        garantizada. Debes saber que el Titular toma las precauciones necesarias
        para evitar el acceso no autorizado o uso indebido de los datos de sus
        usuarios por parte de terceros.
      </li>
      <h2 className="text-lg font-bold">Obtención de datos personales</h2>
      <p>
        Para navegar por TermoApp no es necesario que facilites ningún dato
        personal. Los casos en los que sí proporcionas tus datos personales son
        los siguientes:
      </p>
      <li>Usuario, correo y contraseña para acceder al panel de node-red.</li>
      ...
      <p>
        ...
        info@termoapp.es junto con la prueba válida en derecho como una
      ...
      <p>
        ...
        recopilada, utilizada, gestionada y almacenada por superadmin.es , sólo
        como se describe en el Aviso Legal y en la presente Política de
        Privacidad.
      </p>
      <p>
      ...
      <h2 className="text-lg font-bold">Seguridad de los datos personales</h2>
      <p>
      ...
      <p>
        El sitio Web está alojado en www.termoapp.es. La seguridad de tus datos
      ...
      <h2 className="text-lg font-bold">Contenido de otros sitios web</h2>
      <p>
      ...
      <h2 className="text-lg font-bold">Navegación Web</h2>
      <p>
        Al navegar por termoApp se pueden recoger datos no identificativos, que
      ...
      <h2 className="text-lg font-bold">Aceptación y consentimiento</h2>
      <p>
      ...
      <h2 className="text-lg font-bold">Revocabilidad</h2>
      <p>
        Para ejercitar tus derechos de acceso, rectificación, cancelación,
        portabilidad y oposición tienes que enviar un correo electrónico a
        info@termoapp.es junto con la prueba válida en derecho como una
